...
class Migration(SchemaMigration):
    ...
    models = {
        'trotro.route': {
            ...
            'stops': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'stops_on_route'", 'symmetrical': 'False', 'to': "orm['trotro.Stop']"}),
        ...
        'trotro.route_stop': {
            ...
            'route': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stops_on_route'", 'to': "orm['trotro.Route']"}),
            'stop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stops_on_route_stop'", 'to': "orm['trotro.Stop']"}),
