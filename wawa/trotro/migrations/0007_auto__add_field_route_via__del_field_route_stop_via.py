...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Route.via'
        db.add_column('trotro_route', 'via',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=100),
                      keep_default=False)

        # Deleting field 'Route_stop.via'
        db.delete_column('trotro_route_stop', 'via')


    def backwards(self, orm):
        # Deleting field 'Route.via'
        db.delete_column('trotro_route', 'via')

        # Adding field 'Route_stop.via'
        db.add_column('trotro_route_stop', 'via',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=100),
                      keep_default=False)
