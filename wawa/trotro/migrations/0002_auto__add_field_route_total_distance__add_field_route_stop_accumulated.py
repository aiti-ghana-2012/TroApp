...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Route.total_distance'
        db.add_column('trotro_route', 'total_distance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Route_stop.accumulated_distance'
        db.add_column('trotro_route_stop', 'accumulated_distance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Route.total_distance'
        db.delete_column('trotro_route', 'total_distance')

        # Deleting field 'Route_stop.accumulated_distance'
        db.delete_column('trotro_route_stop', 'accumulated_distance')
    ...
    models = {
        'trotro.route': {
            ...
            'total_distance': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'trotro.route_stop': {
            'Meta': {'object_name': 'Route_stop'},
            'accumulated_distance': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
